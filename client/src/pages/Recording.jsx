...
import { Play, Pause, Square, Mic, Video, Settings, ArrowLeft, RefreshCw, AlertTriangle } from 'lucide-react';
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {/* Left Side: Recording Control Panel */}
        <div className="lg:col-span-2 bg-[#111113] border border-white/5 rounded-3xl p-8 flex flex-col justify-between items-center space-y-8">
          ...
          <div className="w-full space-y-4">
            ...
            <div className="space-y-2 pt-2">
              ...
              {window.electronAPI ? (
                /* Electron App: Direct device selection */
                <select
                  value={systemId}
                ...
                /* Browser mode: Choice between tab capture or BlackHole */
                <div className="space-y-2">
          ...
          <div className="w-full flex items-center justify-center gap-4">
            {uploading ? (
              ...
              <button
                onClick={() => startRecording(meetingId, meeting.title)}
