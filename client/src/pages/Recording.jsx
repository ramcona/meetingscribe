...
export default function Recording({ meetingId, onBack, onRecordingUploaded }) {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8 animate-fade-in">
      ...
      {/* Recorder Board */}
      <div className="bg-[#111113] border border-white/5 rounded-3xl p-6 md:p-8 space-y-8 flex flex-col items-center">
        ...
        {isRecording && activeStreamsRef.current.mixed && (
          <div className="w-full max-w-md p-4 bg-black/40 border border-white/5 rounded-2xl space-y-2">
        ...
        {/* Errors display */}
        {errorMessage && (
          <div className="w-full p-4 bg-red-500/5 border border-red-500/20 text-red-400 rounded-2xl text-xs text-center leading-relaxed">
            {errorMessage}
          </div>
        )}
